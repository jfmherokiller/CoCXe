...
public final class MiscJewelryLib extends ItemConstants
	{
		...
		public const EZEKIELSL:MiscJewelry = new MiscJewelry("EzekielSl", "EzekielSeal", "Ezekiel's Seal", "an Ezekiel's Seal", 0, 0, 800, 0, "Seal containing tiny amount of Ezekiel power. Or so the rumors says. (+3 additional transformation chances)","Seal");
		public const KRATIASL:MiscJewelry = new MiscJewelry("KratiaSl", "KratiaSeal", "Kratia's Seal", "a Kratia's Seal", 0, 0, 800, 0, "Set of seals containing tiny amount of restrictive power. Creater claims it's good for training. (+100(150) to effective level difference when fighting any enemy (training dummy))","Seal");
