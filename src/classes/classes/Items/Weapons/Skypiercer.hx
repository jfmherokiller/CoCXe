...
public class Skypiercer extends Weapon {
		...
		{
			super("Skypier", "Skypiercer", "Skypiercer", "a Skypiercer", "piercing stab", 55, 3840, "Tales has it that this spear tip is so sharp it is said it could pierce through the sky.  Req. 300+ speed and 100+ strength to unleash full attack power", [WP_LARGE, WP_LGWRATH, WP_AP100].join(", "), WT_SPEAR);
		}
