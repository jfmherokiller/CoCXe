...
private function sheilaCowgirlRapesYou():void {
	...
	function fitF():void {
		...
		//(else lib >= 25)
			...
			outputText("; looking into your face, her frown evolves into a mischievous grin.  [sheilaname] about-faces, turning her back to you.  \"<i>Blame yourself for this; it's rude to stare,</i>\" she giggles, hovering over your [cockHeadFit 32].  The woman sinks down with an audible sigh, parting her slick, smooth labia with your tip and swallowing your " + num2Text(Math.round(player.cocks[player.cockThatFits(32)].cockLength)) + " inches.  \"<i>Ohh...</i>\" [sheilaname] moans.  She slips a hand down to your crotch to check how much of your prick is left to go, and starts a bit when she realizes she's taken the entire shaft on the first stroke!");
