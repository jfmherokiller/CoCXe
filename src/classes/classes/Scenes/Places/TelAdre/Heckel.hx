...
public function heckelAppearance():void {
	...
	else outputText("\n\nYou can see Heckel is here, running laps on an indoor track again.");
}
...
private function heckelTraining():void {
	...
	//Centaur or Genderless
		...
		outputText("\"<i>Err, look [name], people around here come in all shapes and sizes and use all sorts of... equipment. Maybe you should go find someone more your type to ask, because I honestly don't know what to do with yours.</i>\"\n\n");
		doNext(telAdre.gymDesc);
		return;
	}
    //Sex!
	...
	if(player.str > 50 && player.hasCock()) outputText("\n\nYou feel pretty strong yourself, and you realize you could probably arm wrestle this hyena-bitch down to size.");
	menu();
	addButton(0, "Oral", heckelOrallyFixated);
	addButton(1, "Be Top Dog", dominateHeckel).disableIf(player.str < 50 || !player.hasCock(),
		"You need to be stronger than her and have a dick for that.");
...
private function heckelLovesAnal2():void {
	...
	else if(player.hasCock() && player.hasBalls()) outputText(SMultiCockDesc() + " pulses beneath you with every thrust, her duo of fist-sized balls slapping into your [balls]. You gasp in surprise as one of her thrusts rubs against your prostate, and she barks out a single laugh above you. \"<i>You moan like a whore, [name], a perfect bitch for me to ride.</i>\"\n\n");
	...
	//[<IF PC IS FEMALE>
	if(player.gender == 2) outputText("  \"<i>I'm going to fuck your ass like you wish I'd fuck your cunt,</i>\"");
	//[<IF PC IS MALE OR HERM >
	else outputText("  \"<i>I'm going to ride your ass like you wish you could ride me,</i>\"");
	...
	//[<HERM PC>
	if(player.gender == 3) outputText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your entire groin, and the knot pushes against the walls of your vagina hard enough to make them rub against each other. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her. Your " + vaginaDescript(0) + " spasms and gushes over your soaked [legs], your asshole spasming around her cock just as much. Your [cocks] soon follows, shooting your own seed up between your " + chestDesc() + " and coating your stomach. Even as your orgasm begins to taper off, you can do little more than lie panting in a pool of your own spunk. Your legs quiver beneath hers as the warmth spreads further up your gut, leading you into a warm and hazy afterglow.\n\n");
	//[<MALE PC>
	else if(player.hasCock()) outputText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your [balls] and cock, making it twitch at your impending orgasm. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her.  Your [balls] get tight as your trapped " + Appearance.cockNoun(CockTypesEnum.HUMAN) + " twitches, shooting your cum up between your stomach and chest. Your legs quiver beneath hers as the warmth spread further up your gut, leading you into a warm and hazy afterglow.\n\n");
	//[<FEMALE PC>
...
private function dominateHeckelConclusion():void {
	...
	if(player.hasBalls()) outputText(", basting your [balls] with her steaming warmth");
	...
	if(silly()) {
		...
		if(flags[kFLAGS.LOTTIE_TIMES_ENCOUNTERED] > 0) outputText(", then give Lottie a high five");
