...
public class CorruptedGlade extends BaseContent implements TimeAwareInterface {
    ...
    public var dryad:DryadScene = new DryadScene();
    public var trappedSatyr:TrappedSatyrScene = new TrappedSatyrScene();
    ...
    public function timeChange():Boolean {
        ...
        if (flags[kFLAGS.CORRUPTED_GLADES_DESTROYED] >= 100) { //Extinct state
            ...
            if (flags[kFLAGS.ZENJI_DESTROYING_CORRUPTED_GLADES] > 0) flags[kFLAGS.ZENJI_DESTROYING_CORRUPTED_GLADES] = 0;
        }
        return false;
    }
        ...
        function vagScene(tentacle:int):void {
            ...
            if (tentacle == 0) { //Small
                ...
                switch (player.vaginas[0].vaginalLooseness) {
                    case VaginaClass.LOOSENESS_TIGHT:
                        tentacleSize = 0;
                        break;
                    case VaginaClass.LOOSENESS_NORMAL:
                        tentacleSize = 4;
                        break;
                    case VaginaClass.LOOSENESS_LOOSE:
                        tentacleSize = 16;
                        break;
                    case VaginaClass.LOOSENESS_GAPING:
                        tentacleSize = 40;
                        break;
                    case VaginaClass.LOOSENESS_GAPING_WIDE:
                        tentacleSize = 65;
                        break;
                    default:
                        tentacleSize = 100;
    ...
    private function destroyTheCorruptedGlades(choice:int):void {
        ...
        switch (choice) {
            ...
            case 5: //Your strength!
                ...
                break;
            default:
                outputText("<b>Please report this error to Ormael/Aimozg.</b>\n\n");
        }
