...
private function faerieRAEP():void {
	...
	//Non-Taurs
		...
		if(player.vaginas[0].vaginalWetness >= VaginaClass.WETNESS_SLAVERING) outputText("releasing a tiny squirt");
		else if(player.vaginas[0].vaginalWetness >= VaginaClass.WETNESS_DROOLING) outputText("dribbling juices");
...
private function faerieCaptureHJ():void {
	...
	if(player.isTaur()) {
		...
		else if(player.statusEffectv1(StatusEffects.FaerieFucked) < 15) outputText("The faerie burps and laughs drunkenly, patting the side of your [leg] and slurring, \"<i>Oh by Marae's ripe titsh!  I needed that.  Do you thhink you could catsch me again?  I love feeling your cum coating my body.</i>\"\n\n");
	...
	//Non-taurs
		...
		if(player.cumQ() > 250) {
			...
			else outputText("Falling backwards as your legs give out, y");
		}
		else outputText("Y");
		...
		if(player.cumQ() > 500) outputText(" in the cum");
