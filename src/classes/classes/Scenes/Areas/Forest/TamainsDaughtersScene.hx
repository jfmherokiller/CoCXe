...
private function fuckYoDaughtersHomie():void {
	...
	outputText("\"<i>Come and get it,</i>\" you shout, strutting forwards.  The crowd surges forwards, mobbing you from all sides.  ");
	...
	function scene(x:int):void {
		...
		sceneHunter.print("Present daughters: " + daughters);
		if (player.cockArea(x) <= 50) {
			outputText("You pick a random body from the crowd, impaling her on your [cock " + (x+1) + "].  The others crowd around, jealous of your chosen cock-sleeve.  She looks up at you, blissful as she hugs against you and grinds her tight body down, raping her virginal hole on the firmness of your [cock " + (x+1) + "].  The others massage your [legs], licking and nibbling your skin as they compete to tempt you into taking them next.");
			if (tamaniPresent) {
				outputText("  Tamani pushes aside the smaller sluts and ");
				if (player.hasBalls()) outputText("cups your [balls].");
				else outputText("licks your taint.");
			}
			outputText("\n\n");

			outputText("In no time, the vise-like grip of her cunt and thrill of taking her virginal passage push you beyond your threshold.  You groan and pump thick loads of jism deep into the tiny twat");
			if (player.cumQ() >= 500) outputText(", bloating her belly until she gurgles and squishes on top of you");
			outputText(".  She falls off with her eyes crossed as her sisters scramble to take her place.");
			if (tamaniPresent) {
				outputText("  Tamani shoves the rest of them away and mounts you, ");
				if (player.tallness >= 60) outputText("scrabbling up enough to ");
				...
				outputText("  Another mounts you, launching herself at you with such force that she knocks you off your [feet] and onto your back.  A hand clamps over your mouth and jams something inside while another massages your throat, forcing you to swallow it.  Numbness flows through most of your body, robbing you of strength and feeling in all but one place...\n\n");
			}
			...
			outputText("Such perverse thoughts, and coming from your own daughters.  ");
			if (player.cor < 33) outputText("You were supposed to save the village from corruption, not breed tiny sluts to overrun it... y");
			else if (player.cor < 66) outputText("You came here to make things better for everyone... well, at least you're helping these girls. Y");
			else outputText("You came here to make things better, but you know you'll keep knocking up Tamani every chance you get.  It's too much fun to resist adding to the sea of green girls. Y");
			outputText("ou moan as a drooling green cunt is pressed into your [face], smothering away any protests you might have offered.  Your tongue laps away, servicing another one of your many goblin offspring as best it can.  It plunges deep to harvest her nectar, making her soak you with juice, performing oral as if it were possessed.  Your eyes cross and you feel your release building, cresting in a wave as it prepares to dump into your ");
			if (!tamaniPresent) outputText("daughter");
			else outputText("favorite goblin MILF");
			outputText(".\n\n");

			outputText("The pressure of orgasm spikes as the first blast takes ");
			if (!tamaniPresent) outputText("your goblin daughter");
			else outputText("Tamani");
			outputText(" in her waiting womb, painting her walls white.  Each successive glob mixes into the slurry of sexual fluids brewing in her slit, until it starts to dribble out.  The goblin on your face cums noisily, filling your mouth with female moisture.   With no other choice, you swallow it down while your tongue keeps trying to pleasure her.  A sudden void of sensation and cold air overtakes your [cock " + (x+1) + "] as you hear the goblins squabbling.  In no time flat a fresh cunt is squeezing over your still-orgasming member, clamping down to form a tight seal as you pump it full of even more fertile seed.\n\n");

			//(Go to End if < 10 daughters), else keep goin
			if (daughters > 10) {
				outputText("As your orgasm trails off, your green cock-sleeve is removed.  You sigh happily, glad the ordeal is over.  Your [cock] manages to continue to throb, and you wonder just how long you'll have to wait for the goblin drugs to wear off.  The answer comes sooner than you think, in the form of a large vial of sweet-tasting liquid.  Your nose is pinched shut by a teal hand and your throat is massaged until you swallow the entire thing.  The result is immediate.  Slight shakes work their way through your body as it reacts to the corrupted drugs.  ");
				if (player.hasBalls()) outputText("Your balls visibly puff up and slosh as one of your daughters plays with them, filling with more seed than ever before.");
				else outputText("Your gut clenches painfully as something inside puffs up.  Pressure builds at the base of your cock and you realize somehow you're more full of cum than ever before.");
				outputText("\n\n");
				if (tamaniPresent) {
				...
				if (daughters > 20) {
					...
					outputText(", but a few of the little sluts don't look satisfied yet.  They crowd around.  One straddles your chest and begins dancing in an erotic display.  Somehow, your [cock " + (x+1) + "] still manages to twitch weakly in response.  Another goblin opens a satchel and pulls out some fruit and a canteen.  She delicately begins feeding you, clearing wanting you to regain your strength.  It seems they aren't finished with you yet.  You down what feels like gallons of water, and then find yourself presented with another flask of pink goo.  Shrugging, you gulp it down willingly, enjoying the sensation of your [cock] re-inflating to its maximum, turgid size.\n\n");
			...
			//(Normal end)
			if (daughters <= 20) {
				outputText("Exhausted and shaken by the ordeal, you lie there as the girls regroup, gathering any dripping seed into bottles or their puffy cunts.  Several of them blow you kisses");
				if (tamaniPresent) outputText(" and Tamani passionately frenches you.");
				else outputText(".");
				outputText("  One of them licks your sore member and says, \"<i>Thanks for all the cream!</i>\"\n\n");
				outputText("Failed check: need more daughters.");
			}
		}
		//[DOESNT FIT]
		else {
			...
			if (tamaniPresent) {
				...
				outputText("She disappears behind you and you cringe, knowing this will probably be at least slightly uncomfortable.  ");
				if (player.tallness > 48) outputText("You can hear her climbing up on something behind you, in order to get to the right height.  ");
				outputText("Your expression of disdain is ruined when one of the sluts stretches wide and slurps your [cockhead] into her mouth.  Her tongue feels like heaven as it slides over your tip, and her sister works the shaft, jerking the spit-lubed monster off with fast strokes.   Your enjoyment is interrupted by a sudden intrusion at your backdoor.  The rubbery flared horse-toy presses against your " + assholeDescript() + ", dribbling a little bit of its strange lubricants into your backdoor as Tamani pushes it forward.   Tiny hands grab your [ass] as it's pushed forward, and you have no choice but to relax and allow it inside.\n\n");
				...
				outputText("Spent, your [cock] wilts, drooping downward as it drips the last of its seed.  Tamani seems oblivious to that fact though, and continues to violate you from behind.  You're about to reach around to dislodge the tiny anal rapist when another squirt of aphrodisiacs releases inside you, catching some of your prostate with the goop.  A torrent of blood rushes to your [cock] and you're suddenly achingly hard again.");
				if (player.hasBalls()) outputText("  Your [balls] ache from the strain, but struggle to churn up more sperm.  ");
			...
			else sceneHunter.print("Failed check - Tamani is not present.");
			outputText("A third goblin suddenly attacks your taint, licking between your " + assholeDescript() + " and ");
			...
			outputText(" as she presses her hard nipples up against your [legs]. ");
			//(No Tamani:
			...
			outputText("You explode, coming harder than ever from the pressure and drugs buried against your prostate.  One of the twins, tired of waiting, pulls your [cock] over and shoves your tip against her slickened folds.  You manage to pump a thick blob of cum deep inside her before her sister snatches it away, grinding her own hungry twat against you until her entire groin is stained white.  They glare at each other, but after seemingly being sated, they return to fondling your [cock] together, using it like a hose to drench their smiling sisters with the remaining cum.\n\n");
			...
			if (!tamaniPresent) outputText("You're handed another bottle as t");
			else outputText("T");
			outputText("he girls shift position, rearranging themselves so that those who got the most love-juice are now positioned alongside you.  ");
			if (!tamaniPresent) outputText("You shrug and drink it, ");
			else outputText("You begin ");
			outputText(" feeling hornier and hornier, as ready now as you were when you got here.  Twitching, your [cock] announces its readiness to repaint these living cum-sponges.  A trio of goblin tongues slip over your shaft, and lip-gloss smeared lips worship every ounce of your life-giving rod.  One of the girls, an older one with prominent breasts, breaks off and begins to scale her way up your body.  She doesn't stop until she's sitting on your shoulders with her hot messy cunt pressed against your face.\n\n");

			outputText("One of the girls on your [cock] gets an idea and mashes her tits against it you while she licks and strokes you.  The combined goblin assault once again achieves its goal, and you are brought to a body shaking orgasm AGAIN.   The swarm of goblins giggles happily as they gather your falling spunk into their waiting cunts.  What doesn't fit inside is slurped up, and soon you're covering a writhing orgy of curvy green women with a thick coat of spunk.\n\n");

			outputText("You finish and collapse backwards, totally drained and losing consciousness.  ");
			if (daughters < 20) {}
			//(20+ daughters:
...
private function legTamanisDaughtersRAEPYou():void {
	...
	clearOutput();
	outputText("Knowing full well that this crowd of goblins isn't going to let you leave while you still have a drop of sperm in your body, you disrobe and walk into their midst, lying down in a soft mossy patch and giving yourself up to the horde completely.  In an instant you're smothered in a sea of supple green flesh, and caressed from head to toe.  The largest of the group is happily stroking ");
	if(player.cockTotal() > 1) outputText("one of ");
	outputText(" your [cocks], teasing you as it near-instantly rises, \"<i>Mommy never told me you were such an easy " + player.mf("man-","") + "slut.</i>\"\n\n");

	outputText("A slippery gash mounts your [face], blocking your view of anything, but a cute navel as pungent pussy slobbers over your lips.  With a resigned sigh, you open your mouth and bury your tongue into one of your many daughters' snatches.  It's tangy and sweet, and juicier than fresh fruit.   The girlish moans you hear let you know how successful your tongue is, and you work harder than ever to kiss and lick her slippery lips, pausing only to suck the tiny bud of her clit into your mouth.\n\n");
	...
	function scene(x:int):void {
		...
		sceneHunter.print("Present daughters: " + daughters);
		if (player.cockArea(x) <= 50) {
			outputText("Effortlessly, she straddles you and guides the entire length of your rod into her honeypot.  Amazingly the tiny girl is able to spread her cunt around you, forming a tight, but not uncomfortable, fit.  ");
			...
			else if(cocks > 2) outputText("More and more hands latch onto the rest of your [cocks], guiding each of them into a tight cunt-hole.   If you could see around the tight body of the slut on your face, you're sure the scene on your crotch would push you over the edge.");
			else outputText("You stiffen as a tongue suddenly presses against your " + assholeOrPussy() + " sliding inside and intensifying the feelings radiating down your fuck-pole until you're unable to hold on.");
			outputText("\n\n");

			outputText("A sudden flow of fluids soaks your [face] and dribbles from your chin.  The face-riding goblin bucks like a bronco, nearly breaking your nose before the strength drains from her body and she slides off into the dirt, panting weakly.   Confronted with the sight of ");
			if(cocks > 2) outputText("so many girls impaled on your flesh");
			else if(cocks == 2) outputText("your daughters' whorish expressions of pleasure");
			else outputText("the sultry gaze of Tamani's oldest daughter as she rides your [cock "+(x+1)+"]");
			outputText(", you can do nothing but cum.  ");
			if(cocks > 1) outputText("Twitching powerfully, your body unloads into the tight, fertile cum-receptacles, giving them exactly what they want.");
			else outputText("Twitching powerfully, your body unloads into the tight, fertile cum-receptacle, giving her exactly what she wants.");
			if(player.cumQ() >= 1000) {
				outputText("  The near-supernatural amount of spooge you produce easily bloats ");
				if(cocks == 1) outputText("her belly until she looks a little pregnant");
				else outputText("each of their uteruses until they look a little pregnant");
				outputText(".");
			}
			...
			sceneHunter.print("Is Tamani present?");
			//TAMANI IS THERE:
			if (tamaniPresent) {
				...
				outputText("She gives ");
				if (cocks > 1) outputText("one of ");
				outputText("your deflating [cocks] a playful slap, smirking when it stiffens in response, \"<i>Honestly, you're so shameful, getting hard again from such an innocent touch.  I didn't know you wanted to make our little family that much bigger.</i>\"\n\n");

				outputText("Pantomiming a sigh, Tamani drags her finger from your ");
				...
				outputText("Tamani massages your ");
				if (player.biggestTitSize() < 1) outputText("chest");
				else outputText(allBreastsDescript());
				outputText(" as she mounts you, ");
				outputText("squeezing her dripping wet cunt around your [cock " + (x+1) + "].  She explains, caressing your cheek as you start to drool, \"<i>You see, [name], this potion is a special one.  You can probably feel it now, emptying your mind and shutting down your thought processes.  That's what it's supposed to do.  You won't remember anything when I'm done either, aside from how great my pussy feels on your [cock " + (x+1) + "]</i>.\"\n\n");
				...
				outputText(" churning with lust and desire, ready to give life to another batch of daughters for your mistress.  ");
				if (flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] < 10) outputText("'Wait... wife... mistress?' your mind wonders, rejecting the foreign thoughts.  You look up at Tamani, confused for a moment");
				else outputText("Yes, that sounds so right – Tamani is your wife, and it's your husbandly duty to keep her pregnant.  You dwell on that for a moment");
				...
				outputText("Your mistress steps away, swaying her more-than ample hips from side to side as she saunters past the throng of still-hungry goblins.  You shake your head, feeling a little out of sorts, but before you get a chance to puzzle it out, ");
				if (daughters < 20) outputText("the small pack of goblins is upon you, forcing liquids down your throat and making you fill cunt after cunt with sticky seed.");
				else if (daughters < 30) outputText("the pack of goblin daughters is upon you, forcing potent aphrodisiacs down your throat as you're raped for hours, forced to pack cunt after cunt full of jism.");
				else outputText("the massive group of goblins is on top of you, drugging and raping you over and over until you've had dozens of orgasms and licked off nearly as many cream-bloated sluts.");
				outputText("  As you lie there, drugged and drained, your daughters form up in a line and kiss you, one after another, each whispering pleasantries like, \"<i>Thanks dad,</i>\" or \"<i>Yummy cum daddy,</i>\" before flouncing off, sloshing into the woods.");
			...
			//NO TAMANI:
				...
				sceneHunter.print("Failed check: Tamani not present..");
				if (daughters < 40) sceneHunter.print("Failed check: need more daughters!");
				//(SMALL PACK)
				if(daughters < 20) {
					outputText("The smaller girls take turns, mounting your cum-soaked rod one after another, using their hungry cunts like cum-sponges until your [cock "+(x+1)+"] is polished with feminine fluids and cleaned of any residual jism.  After so many repeated mountings, you're hard and ready to cum again, and the horny sluts know it.   You're crammed back into each one of them, one after another in a barrage of quick fucks.  Each girl is only given a few seconds on your rod before she's pulled off by her peers and replaced by another ecstatic goblin.  While waiting for their next turn, the spare girls tease you, tweaking your " + nippleDescript(0) + "s while licking your ears and whispering, \"<i>Don't cum for her, it'll be much better in my hot little box,</i>\" or, \"<i>You won't cum for that skank, will you?  Save your baby-batter for me!</i>\"\n\n");

					outputText("Amazingly, you orgasm again.  An orgiastic squeal erupts from your [cock "+(x+1)+"]'s current owner, breaking off into pants and gasps ");
					if(player.cumQ() < 100) outputText("as you twitch underneath her, emptying the last of your cum inside her.");
					else if(player.cumQ() < 500) outputText("as you twitch underneath her, pumping her full of cum, thoroughly seeding her womb with spunk.");
					else outputText("as you twitch underneath her in powerful spasms, blasting huge gouts of cum into her waiting body until her belly is bloated with seed and it begins to squirt out around you in time with each eruption of spunk.");
					outputText("  Disappointed moans rise up from the others as they realize they've lost the cum-lottery.   The winner, patting her belly happily, stands up, filling the air with a loud 'slurrrrrp' as her twat noisily releases your [cock "+(x+1)+"].");
					if(player.cumQ() >= 500) outputText("  A few enterprising goblins gather around, gathering up the loose spunk and shoveling it into their holes.");
					outputText("\n\n");

					outputText("Tired from the sexual acrobatics, your daughters gather up their possessions and begin dispersing, but a few stick around to lick your [cock "+(x+1)+"] clean and give you deep french-kisses.  Exhausted as well, you begin to doze off, but not before a girlish voice whispers in your ear, \"<i>Thanks daddy!  I'll bring your daughters back once they've grown up so you can have their cherries too.</i>\"\n\n");
				}
				//(MEDIUM PACK (or bigger))
				else {
					outputText("The smaller girls take turns, mounting your cum-soaked rod one after another, using their hungry cunts like cum-sponges until your [cock "+(x+1)+"] is polished with feminine fluids and cleaned of any residual jism.  After so many repeated mountings, you're hard and ready to cum again, and the horny sluts know it.   You're crammed back into each one of them, one after another in a barrage of quick fucks.  Each girl is only given a few seconds on your rod before she's pulled off by her peers and replaced by another ecstatic goblin.  While waiting for their next turn, the spare girls tease you, tweaking your " + nippleDescript(0) + "s while licking your ears and whispering, \"<i>Don't cum for her, it'll be much better in my hot little box,</i>\" or, \"<i>You won't cum for that skank, will you?  Save your babby-batter for me!</i>\"\n\n");

					outputText("Amazingly, you orgasm again.  An orgiastic squeal erupts from your [cock]'s current owner, breaking off into pants and gasps ");
					if(player.cumQ() < 100) outputText("as you twitch underneath her, emptying the last of your cum inside her.");
					else if(player.cumQ() < 500) outputText("as you twitch underneath her, pumping her full of cum, thoroughly seeding her womb with spunk.");
					else outputText("as you twitch underneath her in powerful spasms, blasting huge gouts of cum into her waiting body until her belly is bloated with seed and it begins to squirt out around you in time with each eruption of spunk.");
					outputText("  Disappointed moans rise up from the others as they realize they've lost the cum-lottery.   The winner, patting her belly happily, stands up, filling the air with a loud 'slurrrrrp' as her twat noisily releases your [cock "+(x+1)+"].");
					...
					if(player.hasBalls()) outputText("balls begin swelling, trembling as they visibly inflate, preparing a massive load of seed.");
					else outputText("groin shifts uncomfortably, trembling as it begins preparing a massive load of seed.");
					outputText("  Your [cocks] spasms, twitching as unearned pleasures fill the flesh and bring you to climax.\n\n");
					...
					if(daughters < 40) {
						outputText("Locked in a ceaseless orgasm, you're raped by one goblin after another.  A parade of tight pink pussies and their green-skinned owners passes by you, and once each of them is dripping with white seed, they take the time for a second pass.  By the time it's over, you're raw and sore, and your ");
						if(player.hasBalls()) outputText(ballsDescriptLight() + " hurt");
						else outputText("crotch hurts");
						outputText(" from having to generate such a ridiculous quantity of spooge.  The crowd of milling goblins seems much less frantic now that they've gotten what they want.  You're kissed and licked and massaged by the thankful mass, and you lose yourself to unconsciousness, still dribbling semen.");
						sceneHunter.print("Failed check")
					}
		...
		//[NO FIT]
			...
			if (!tamaniPresent) {
				var y:int = (x == 0 ? 1 : 0);
				var z:int = (x <= 1 ? 2 : 1);
				outputText("Effortlessly, Tamani's daughter launches herself onto you, straddling your body as she tries to work your [cock] into her tight gash.  No matter how hard she tries, she just can't get it in.  She looks up at you in confusion and asks, \"<i>How in Marae's cunt can my Mom take this beast?</i>\"\n\n");

				outputText("Frowning in consternation, she presses it down onto your belly and sits on top, spreading her cunt as wide as she can around the bulge your urethra makes on the underside of your [cock].  Though you can't see her, the feeling of her starting to slide along your length is wonderfully pleasurable.  After a few moments you can feel her getting into it, leaning over and pressing her taut body and heavy breasts against you as well.  Incredibly turned on by the mental picture you're forced to form, you attack the cunt riding your [face], licking it with feverish intensity.\n\n");

				outputText("A sudden flow of fluids soaks your [face] and dribbles from your chin.  The face-riding goblin bucks like a bronco, nearly breaking your nose before the strength drains from her body and she slides off into the dirt, panting weakly.  Now freed from your juicy prison, you can see the oldest daughter as she's squeezing on your [cock], sliding her gash and ");
				if(daughters < 20) outputText("pert ");
				else if(daughters > 40) outputText("heavy ");
				outputText("breasts over every part of it.");
				if(cocks == 2) outputText("  Another one of the petite sluts climbs aboard your [cock "+(y+1)+"], squealing happily to her sister as she joins her in riding you.");
				if(cocks > 2) {
					outputText("  A third, wearing slutty pink make-up with platinum blonde hair, lays out across your ");
					if(cocks > 3) outputText("remaining " + multiCockDescriptLight());
					else outputText(cockDescript(z));
					outputText(".");
				}
				outputText("\n\n");

				outputText("She pivots around, placing her drooling, wet gash against your [cockhead] and begins vigorously jerking you off.   Her ass bounces hypnotically on your ");
				if(player.biggestTitSize() < 1) outputText("chest");
				else outputText(allBreastsDescript());
				outputText(", sending a fresh surge of arousal through your [cocks].   Another one of the girls leans down between your [legs] licking your ");
				if(player.hasBalls()) outputText("balls");
				...
				outputText(", and the sensitive [skin.type] around your crotch.   The busty girl on your [cock] teases, \"<i>Go ahead and let it out " + player.mf("stud","sexy") + ".  I'm tired of getting your cream second-hand, so squirt it right into my hot little cunt.</i>\"\n\n");
				...
				outputText("Your body caves into their demands.  The girl between your [legs] licks hard as your muscles tense with orgasm.  ");
				...
				if(cocks == 1) {
					...
					//Cum stuff
					if(player.cumQ() < 100) outputText("your orgasm ends, pulsing weakly inside the sloppy goblin flesh.");
					else if(player.cumQ() < 500) outputText("your orgasm drags on, pumping the slut up until she looks slightly pregnant.");
					else {
						outputText("your orgasm drags on, splattering cum everywhere as you plump up the girl until she looks pregnant.");
						if(player.cumQ() > 1000) outputText("  Seed gushes out her opening, actually pushing the goblin away as your orgasm splatters cum into the grass.");
						if(player.cumQ() > 5000) outputText("  The other goblins frolic around in the stuff, greedily shoveling it into their dripping pussies with both hands as you form a small lake of seed.");
					}
				}
				//Multi jizz scene
				else {
					...
					//Orgazmo
					if(player.cumQ() < 100) outputText("your orgasm ends, pulsing weakly inside the sloppy goblin flesh.");
					else if(player.cumQ() < 500) outputText("your orgasm drags on, pumping the sluts up till they look slightly pregnant.");
					else {
						outputText("your orgasm drags on, splattering cum everywhere as you plump up the girls until they look pregnant.");
						if(player.cumQ() > 1000) outputText("  Seed gushes out their openings, actually pushing the goblins away as your orgasm splatters cum into the grass.");
						if(player.cumQ() > 5000) outputText("  The other goblins frolic around in the stuff, greedily shoveling it into their dripping pussies with both hands as you form a small lake of seed.");
					}
				}
				outputText("\n\n");
				...
				if(cocks == 1) outputText("Y");
				else outputText("Each of y");
				outputText("our [cocks] is now rock solid and beading pre-cum at the tip.  ");
				//(single)
				if(cocks == 1) outputText("The purple-lipped cock-slut grabs your [cock] and makes a show of smearing the slippery fluid over your shaft, lubricating it as she jacks you off.  Her warm lips form a tight seal on your [cockhead] as the young goblin begins lapping at your pre-cum as she sucks it from your urethra.   It feels heavenly, and your " + hipDescript() + " pump weakly into the air in an instinctive bid to enhance the sensation.");
				//(multiple)
				else {
					outputText("The purple-lipped cock-slut grabs hold of one of your [cocks] and makes a show of smearing the slippering fluid over the shaft, lubricating it as she begins to jack you off.  Her sisters, taking the cue, step over the other sated sluts and grab hold of your [cock "+(y+1)+"], fondling it lovingly.  ");
					if(cocks > 2) outputText("They spread out until every one of your [cocks] has at least one goblin hanging off it, stroking and touching you.  ");
					outputText("It feels heavenly, and your " + hipDescript() + " pump weakly into the air in an instinctive bid to enhance the sensation.");
				}
				outputText("\n\n");

				outputText("The goblin who served between the legs crawls back into position, and you realize she must be the youngest, and therefore the lowest on the goblin totem-pole.  Her eager tongue is just as skilled as it was minutes ago, and between her attentions and the tongues on your [cocks], you're leaking streamers of liquid lust.  Hands run over your ");
				if(player.biggestTitSize() < 1) outputText("chest");
				else outputText(allBreastsDescript());
				...
				outputText("Ripples of convulsive pleasure wrack your midsection as you feel the muscular contractions of your orgasm threatening to tear you apart.   Your ");
				//(single)
				if(cocks == 1) outputText("[Cock "+(x+1)+"] blasts a wave of seed directly into your cock-obsessed daughter's mouth, flooding it until she falls off of it with jism dripping from her nostrils.  You squirt a massive spurt high into the air overhead, and more than a few goblins are running around with their tongues out, trying to catch it in their mouths.   Each wave of seed is larger than the last, erupting from your [cock] like a geyser.   Soon everyone is spattered in a layer of the stuff, and your gut-clenching orgasm tapers down to a more reasonable, but constant, slow flow of semen.  Each of your daughters comes up and takes turns angling your shaft into her waiting cunt, allowing the thick fluid to fill her to capacity before waddling off.  Then the next girl does the same, and the next, and the next...");
				//(Multi)
				else outputText("[cock All] blast waves of seed directly into your cock-obsessed daughters' mouths, flooding them until they fall off with jism dripping from their nostrils.   You spurt massive loads high into the air overhead, and more than a few goblins are running around with their tongues out, trying to catch the seed in their mouths.  Each wave is larger than the last, erupting from your [cocks] like a geyser.  Soon everyone is covered in a thick coating of the stuff, and your gut-clenching orgasm tapers down to a more reasonable, but constant, slow flow of semen.  Each of your daughters comes up and guides a shaft into her waiting cunt, filling herself to capacity with the thick fluid before waddling off.   Then the next set of girls does the same, and the next, and the next....");
				outputText("You're done in by the effort, and quickly lose consciousness.");
			}
			//[Tamani is There]
			else {
				outputText("A scuffle in the crowd breaks out to your right, and though you can hear it, the jiggling ass and delicious pussy of the goblin slut on your face makes it impossible to see what's going on.  You do what any horny " + player.mf("male","herm") + " would do in your position – groan into the slippery box and ignore it, focusing on the feel of skilled hands fondling ");
				...
				outputText("\"<i>Mother always said you had to keep your men on a tight leash, and boy was she ever right – you've been cheating on Tamani!  With your own daughters!</i>\" exclaims your ");
				if(flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] >= 10) outputText("wife");
				else outputText("\"wife\"");
				outputText(" in mock indignation.   She taps her chin for a moment, ignoring her daughters as they continue to lick and stroke ");
				if(cocks) outputText("each of ");
				outputText("your [cocks].  Your eyes roll back in blissful pleasure as Tamani declares, \"<i>Tamani will take care of you, husband.  You're going to cum into these girls' hungry twats until they have to waddle home, and then you're going to remember why Tamani's cunt owns your " + Appearance.cockNoun(CockTypesEnum.HUMAN) + ", forever.</i>\"\n\n");

				outputText("Tamani pulls out a ring gag, shoves it into your protesting mouth, and pulls the straps securely around the back of your neck.  She tousles your " + hairDescript() + " as you squirm, but the crowd of goblins easily keeps you subdued, assisting their mother now that they know her plans.   You ");
				if(player.cor > 66) outputText("sigh, actually anticipating what's about to come");
				else if(player.cor > 33) outputText("don't resist, knowing there's no way to stop what's about to happen");
				else outputText("shudder, struggling to pull free");
				...
				outputText("\"<i>Ok girls, line up; Daddy's gonna start squirting for you, so grab hold of that monster he's got and hold the tip against your horny little cunts until you're full.  And don't be greedy, once you've got a puss full of seed waddle on home, ");
				if(daughters < 20) outputText("there's other girls waiting");
				else if(daughters < 35) outputText("we've got a lot of girls to fill up");
				else outputText("there's a TON of you here so you'll need to move quick if you each want a turn");
				outputText(",</i>\" commands the goblin mother.\n\n");

				outputText("Her words are downright prophetic.  Churning, bubbling warmth floods your crotch with need as you look on, moaning.  Your back arches and your eyes cross in an involuntary reaction to your drug-induced orgasm.  Grunting, you twitch as the goblins line up, the eldest daughter grabbing home of your flexing [cock] as it begins to erupt.  Strangely, it isn't the pulsing, squirting orgasms you're used to.  Instead, a steady stream of cum washes out over the girl's abdomen as she lines up, eventually grinding her wet pussy against your straining urethra.  She giggles with lewd pleasure, grinding against your swollen [cockhead] as her womb is pumped full of semen.  Her belly quickly rounds out, and she's forced to step away, leaving you to soak your belly while the next of your daughters gets in position.\n\n");

				//(MULTI)
				if(cocks > 2) {
					outputText("Meanwhile your other cocks are wasting their spunk over your belly, so some of the waiting girls grab them and pull them aside, ramming their tips deep inside their seemingly bottomless fuck-holes.  They giggle and run their manicured nails over your ");
					if(player.biggestTitSize() < 1) outputText("chest");
					else outputText(allBreastsDescript());
					outputText(", circling your sensitive nipples");
					if(player.biggestLactation() >= 1) {
						outputText(" as they start to ");
						if(player.biggestLactation() < 2) outputText("leak");
						else if(player.biggestLactation() < 3) outputText("drip");
						else if(player.biggestLactation() < 5) outputText("spew");
						else outputText("fountain");
						outputText(" milk");
					}
				...
				//(SINGLE EXTRA)
					...
					outputText("Meanwhile your other " + Appearance.cockNoun(CockTypesEnum.HUMAN) + " is wasting its spunk over your belly, so one of the waiting girls grabs it and pulls it to the side, ramming its tip deep inside her seemingly bottomless fuck-hole.  She giggle and runs their manicured nails over your ");
					if(player.biggestTitSize() < 1) outputText("chest");
					else outputText(allBreastsDescript());
					outputText(", circling your sensitive nipples");
					if(player.biggestLactation() >= 1) {
				...
				if(flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] > 10) outputText("She's the best wife ever.  You nuzzle deep into her cleavage, sighing happily.");
				else if(flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] > 5) outputText("She really is a great wife... wait, wife? You shrug away the thought and enjoy slowly motorboating her breasts.");
				else outputText("She really isn't that bad to you, is she?  You sigh and nuzzle against her jiggly love-pillows.");
				...
				outputText("Pink haze crowds away your thoughts as your glare melts away into dopey confusion.  Tamani giggles and says, \"<i>");
				//(Done before)
				if(flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] > 0) outputText("Don't you remember the last time we did this?  Of course not.</i>\"  Your hot goblin wife gestures at your suddenly swollen and erect [cock], and continues, \"<i>Your dick remembers my special potion though.  Now, let's get back to teaching that wonderful cum-spout of yours how to behave around its wife and mistress.</i>\"\n\n");
				//(Not Done Before)
				...
				outputText("Tamani slides her jiggling body overtop of you, placing her sopping wet pussy directly over-top of your [cock].  The warm wet fluids of her desire slowly drip down onto you until your entire surface is coated in her clear feminine-drool and the entire area smells like her cunt.  She shivers and looks into your eyes, smiling at your mindless expression as she lectures, \"<i>Feel how hard your dick is?  That's because it smells my hungry, wet pussy.  It knows that it wants to cum for my pussy.  Your cock wants nothing more than to touch my cunt, worship it and bathe it with cum.</i>\"\n\n");
...
private function tamaniDaughtersCombatLossDrain():void {
	...
	else outputText("Your abused body slips in and out of consciousness, but the crowd applies salves as they travel to slowly invigorate your form.  Their hands keep touching and stroking you, and despite your mighty efforts to resist, you find yourself aroused and willing in short order.");
	outputText("\n\n");
	...
	if(cocks > 1) outputText("one of ");
	outputText("your [cocks], keeping your more than turned on enough to go along with whatever they have planned.\n\n");
	if(!player.isTaur())
		outputText("The hands holding you slowly lower you into a comfortable feeling chair, securing your [legs] into tightly bound stirrups.");
	else
		outputText("The hands holding you slowly lower you down onto your back, guiding you into a combination chair and harness designed to accommodate a centuar's size and shape.  Before you know it, straps secure your [legs] into tightly bound restraints.");
	outputText("  A moment later, your hands are strapped into equally firm cuffs.  By this point, your lust-dulled mind has begun to worry, and you start to struggle, but binding leather straps are passed over your chest, midsection, and upper thighs, then tightened against the chair to completely restrain you.  Perhaps the only ");
	if(cocks > 1) outputText(" things not restrained are your [cocks], standing at attention despite, or perhaps because of, your predicament.\n\n");
	else outputText(" thing not restrained is your [cocks], standing at attention despite, or perhaps because of, your predicament.\n\n");
	...
	outputText("You shiver as your manhood");
	if(cocks > 1) outputText("s are");
	else outputText(" is");
	outputText(" totally encapsulated within ");
	if(cocks == 1) outputText("a ");
	outputText("wet orifice");
	if(cocks > 1) outputText("s");
	outputText(".  They're so cold that you shiver involuntary against your restraints.  The blue-haired girl growls, \"<i>Hey bitch!  Crank the fuckin' machine up before you make Dad's dick");
	if(cocks > 1) outputText("s");
	outputText(" wilt!</i>\"\n\n");

	outputText("The machinery's humming gets louder as an unseen goblin does as she is told.  Noisy, wet suckling fills the room as the dozens of artificial mouths activate.  The wet, slimy substance encapsulating you immediately heats until it feels as warm as a maiden's love, and a gentle suction pulls on ");
	if(cocks > 1) outputText("each of ");
	outputText("your [cocks] until it feels much harder and thicker than normal.  You stifle an involuntary groan, but fail to conceal your lust-filled pants from your audience.   A daring girl leaps onto your ");
	if(player.biggestTitSize() < 1) outputText("chest");
	else outputText(allBreastsDescript());
	...
	//EXHIBITIONISTZ
	if(flags[kFLAGS.PC_FETISH] > 0) outputText("unimaginably turned on by being used and abused by such machinery in front of an audience of your own horny children.");
	else if(player.cor > 60) outputText("turned on by being milked in such an obscene way.");
	else outputText("horrified at the situation but unable to resist arousal as you're constantly sucked and pleasured.");
	outputText("\n\n");

	outputText("A trickle of warm fluid flows into you, and immediately your skin tingles, burning with heat and need.  ");
	if(player.hasBalls()) outputText("Your balls tighten inside your sack and swell up like sponges, slowly increasing in size in time with your desire.");
	else outputText("Your body feels tight and needy, your gut clenching as your body adjusts to the drugs it's absorbing so readily through your " + assholeDescript() + ".");
	outputText("  The suckling pleasure around ");
	if(cocks > 1) outputText("each of ");
	outputText("your [cocks] seems to slowly increase as more of the drugs are absorbed by your body, until escaping the straps for your freedom is longer a concern.   Now all that matters is getting free so that you can fuck ");
	if(cocks == 1) outputText("that");
	else outputText("those");
	outputText(" mechanical hole");
	if(cocks > 1) outputText("s");
	...
	if(player.hasBalls()) outputText("Straining and shaking, your [balls] clench against you, feeling tight as your body struggles to pump out the spooge they're producing.");
	...
	outputText("The lactating green girl stops breast-feeding you and climbs off you, fed up that you're too busy moaning to properly suckle.  A few of the giggling goblins slap your face, laughing out loud when you fail to even register the blows.  The never-ending flow of orgasmic goop flooding out from ");
	if(cocks > 1) outputText("each of ");
	outputText("your [cocks] has your brain flooded with pleasure, blocking any other thoughts or feelings from arising from the swirling morass of fuck.\n\n");
...
private function tamaniDaughtersBadEndChoice():void {
	...
	if(SceneLib.exgartuan.dickPresent()) outputText("Exgartuan barks, \"<i>Hell yes I do!</i>\" but the goblin only smirks down for a moment before looking back at you.\n\n");

	outputText("(Options: Yes, No, I'd rather fill your cunts individually & personally)");
...
private function tamaniDaughtersYesBadEndMePlease():void {
	...
	if(SceneLib.exgartuan.dickPresent()) outputText("Exgartuan moans, \"<i>Ohhhhhh yeeeeaaaaahhhh...</i>\" before slipping into silence.\n\n");
...
private function tamaniDaughtersDeclineBadEnd():void {
	...
	outputText("The restraints pop off you at once, and you pull the tubes and IV's from your skin.  You grunt with discomfort and remove the final tube from your " + assholeDescript() + ".  Climbing off the table, your [legs] wobble unsteadily as you try to get your balance.   The goblin says, \"<i>Go on home dad before I strap you back down and teach you to enjoy my gifts!</i>\"\n\n");
...
private function tamanisDaughtersFillIndividuallyBADEND():void {
	...
	outputText("You agree to do just that, ");
	if(player.cockTotal() > 1) outputText("each of ");
	outputText("your [cocks] rising to full hardness in anticipation.  Your daughter pats ");
	if(player.cockTotal() > 1) outputText("one of them");
	else outputText("it");
	outputText(" as if it were a person and smiles as she pops the restraints from your chair.  She helps you as you stagger up to your [feet], though the feeling of her hand stroking ");
	if(player.cockTotal() > 1) outputText("a");
	else outputText("your");
	outputText(" [cock] doesn't make it easy.  The pair of you journey deeper into the caves to a massive antechamber filled with pregnant goblins.  Some are eating, others are sewing at tables, tinkering with machinery, or fiddling with alchemical equipment.  All of them turn to look at you as you enter.\n\n");
...
private function loseToDaughtersWithTamaniThere():void {
	...
	clearOutput();
	flags[kFLAGS.TIMES_FUCKED_TAMANIS_DAUGHTERS]++;
	outputText("Your attempts to resist prove to be in vain, as your daughters and their extra-curvy mother have completely defeated you.  ");
	...
	outputText("The potion's bottle becomes a plug for your mouth as Tamani forces your mouth open.  She tips it back and massages your throat with one hand, forcing you to gulp down the fluid.  ");
	if(flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] < 2) outputText("It tastes syrupy-sweet");
	else outputText("It has a familiar taste that you can't quite place");
	outputText(" and nearly makes you gag, but Tamani makes sure you drink down every drop.  An immediate numbness spreads through your body, starting at your fingertips.  It slowly crawls up your arms and then starts at your [feet] as well.  In no time it's hard to move, and it becomes hard to think.  Your mind feels almost like its full of cotton-candy, with fuzzy pink stuff constantly getting in the way of your thoughts.\n\n");
	...
	//(ALT)
	else if(player.cumQ() < 250) outputText("Cum splatters over Tamani's hand and forearm, even hitting her ass and hips as you form a thick puddle over your torso that drips to the ground.");
	//(ALT2)
	else if(player.cumQ() < 600) outputText("Cum splatters out in thick waves, soaking Tamani's hand, forearm, and hips with thick puddles of the stuff.  It pools on your belly for a moment, then rolls off you, forming a small pool on the ground as you keep squirting.");
	//(ALT3)
	else {
	...
	if(player.cockTotal() > 1) outputText("each of ");
	outputText("your [cocks] grows back to full erectness and trembles with desire, ready to seed a womb.  The girls ");
	if(player.cockTotal() == 1) outputText("grab your [cocks] and stroke it with long slow strokes, just like their mother.  Unlike her, they don't seem content to wait, and in seconds a slippery gash is stretching to accommodate your cock-head.\n\n");
	else outputText("each grab one of your [cocks] and stroke it with long slow strokes, just like their mother.  Unlike her, they don't seem content to wait, and in seconds a slippery gash is stretching to accommodate each cock-tip.\n\n");

	sceneHunter.selectFitNofit(fitF, nofitF, 50);
	//(TOO BIG)
	function nofitF():void {
		outputText("Sadly, you're just too big to properly impregnate your daughter, and a stab of worry that you might be a bad father lances through you.  ");
		if(player.cockTotal() == 1) {
			...
			if(player.cumQ() > 700) outputText("It gets everywhere as her womb fails to contain your massive load, even after you've bloated her belly with the stuff.");
	...
	//(FITS)
	function fitF():void {
		outputText("Thankfully, the hungry goblin twat is able to devour your [ock with ease.  Those pliable, fluid-slicked cunt-walls clench ever-so-tightly around you");
	...
	function sharedEnd():void {
		outputText("\n\nDrained from two amazing orgasms, you start to nod off, but you're happy knowing they'll keep you hard and cumming until every empty pussy is full of thick baby-making cream.");
...
internal function loseToDaughters():void {
	...
	if(player.cockTotal() == 0) {
		outputText("\n\nThe sexy sluts pout, \"<i>Why did you have to go and get rid of your dick!?</i>\" before something hits you in the head, HARD, knocking you out.");
		cleanupAfterCombat();
		return;
	}
	sceneHunter.print("3 random scenes, depending on whether Tamani is present");
	if(rand(2) == 0)
		doNext(tamaniPresent ? loseToDaughtersWithTamaniThere : tamaniDaughtersCombatLossDrain);
