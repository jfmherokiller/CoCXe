...
public function encounterRogarSwamp():void {
	...
	if(flags[kFLAGS.ROGAR_PHASE] == 0) {
		outputText("While wandering through the swamp you hit a patch of soft ground; struggling with your balance, you topple over and find yourself falling face-first into the sodden peat and breaking through.  With a dissatisfied grunt, you manage to squirm upright in the filth, your mud-covered head and arms breaking the surface of the heavy gunk again." + (player.armorDescript() != "gear" ? "You can feel the wet seeping through your clothes, making the fabric stick to your form.  " : "") + "  Before you can wipe the mess from your eyes, the sound of footsteps squelching through the muck draws near, and soon a rough, green hand grips you by the shoulder and pulls you from the bog.  You cough and sputter to get the filth from your mouth, and a large hand pats your back to help.  Through the coughing, you wipe your eyes enough to make out your 'rescuer'.  There stands a hulking figure with olive green skin; he must be easily over seven feet tall, his bald face eyeing you up and down with an expression of interest.  \"<i>Aww, look at'cha.  Didn't like suckin' dirt?</i>\"  The man teases you through a grin that shows off rows of sharp teeth, complete with small tusks that jut over his upper lip.  Despite the grin and hand patting your back, he is far more intimidating than charming.  His strong, large hands move to rest on his hips just above his ragged shorts, puffing his bare chest out proudly.  Your eyes drop from his grin to pass over the swell of his pectorals and clenched muscle-gut, his bulging abdominals like fat fish swimming beneath a sea of green skin.  Further you look, trailing down his body.  Even his bare legs are thick with muscle, and as your eyes pass over his calves the man's voice rumbles from deep within his chest.  \"<i>Ain't ya seen a orc a'fore?</i>\" Even the laugh following resounds with masculinity.  \"<i>I'm Ro'gar, an' I live in this here swamp.  I've lived here most've m'life.  I used ta wrestle gators 'fore they got harder to find.</i>\"\n\n");
 		camp.codex.unlockEntry(kFLAGS.CODEX_ENTRY_ORCS);
		...
		//((Corruption 70 or more))
			...
			if(player.isNaga() || player.tailType > Tail.NONE) outputText("  Your tail flicks about happily.");
			outputText("  Should you really wait for him?");
		}
		...
		//((high femininity or breasts >=B-cup, libido less than 50))
			...
			outputText("You grin as you chat with Ro'gar mindlessly.  ");
			//[(int <30)
		...
		//((androgynous or masculine and breasts <= A-cup, libido less than 50))
			...
			else outputText("it makes you wonder what Ro'gar was up to.");
			outputText("  Ro'gar follows your gaze, then his eyes glint oddly as he snickers.  \"<i>Care ta... return the favor?</i>\"  He slyly winks at you, eyes flicking from you to the bucket and back again.");
			//goto sexy choices
		}
	...
	//Not sure what determines this yet
		...
		//((androgynous or masculine and breasts <= A-cup))
			...
			//(Dirt Mc Girt = 2)
			if(flags[kFLAGS.ROGAR_DIRT] == 2) outputText("\"<i>[name], y'all took off on me real quick like,</i>\" he says through a snicker.  The joke falls flat and the orc seems to blush lime green as you stare at him uncomprehendingly.  He rubs the back of his neck with a hand before continuing.  \"<i>Sorry about that.  I was plumb tuckered out afterwards.</i>\"\n\n");
			//(merge sex and non-sex, new PG)
			outputText("\"<i>Come on in.</i>\"  Ro'gar extends a hand, welcoming you inside.  You quickly take a seat and fold your arms");
			if(player.lib > 50) {
				outputText(" over your musk-fueled, growing ");
				if(player.hasCock()) outputText("bulge");
...
private function waitForChunkyOrcLoe():void {
	...
	if(flags[kFLAGS.ROGAR_PHASE] == 0) {
		...
		//((If libido is 50 or more))
			...
			outputText("  Something about the burly orc rubbing you down with warm water excites you.");
			if(player.hasVagina()) {
				outputText("  Your " + vaginaDescript(0) + " starts to quiver as the warm water rolls over its lips, moistening in excitement as your skin is rubbed over by strong hands.  Your chest heaves as it relaxes to his touch, your " + nippleDescript(0) + "s becoming stiff under his rubbing.");
...
private function okayBroLetsHaveAGayCarwash():void {
	...
	outputText("You set the towel down with Ro'gar's clean, slick body in front of you.  As you watch the droplets of water travel over his sculpted body, you lean your head down to get a better look.  Up close, his pores can be seen secreting an oil-like liquid over his skin.  Licking your lips, you give his green skin a perfunctory kiss.  His musk is strong, only serving to excite you further as your tongue glides over his flesh, tasting the pheromone-laden oil.  Your eyes widen as the heat hits your mouth, making you pant; you feel your skin tingle and your hair stand on end.  Soon, it hits your loins and you can feel yourself growing painfully aroused" + (player.armorDescript() != "gear" ? " beneath your clothes" : "") + ".  Ro'gar gives you a knowing grin.  \"<i>Go on, there's plenty more where that came from.</i>\"  Arching his back to brush his stomach more over your [face], the slime clings to your skin and causes it to flush with heat.  You let out a moan, feeling its effect and uncontrollably shuddering at the increased sensations across your body.  All of this stirs a hunger deep inside as you lean over to lick your tongue over his abs, coaxing low groans from the orc above.  Your lips caress and kiss over his slick skin, your tongue tracing each twitching muscle.  You know no boundary, tongue digging between each hard bulge.  Your hands reach over to press against his skin, feeling the heat under your fingertips as you rub his built body.  Saliva gleams across his skin in the trails your tongue leaves behind, sliding along his core and toward his pecs.  You lick with hunger between his flexing breasts, hands cupping each one as you massage them under your fingers.  Ro'gar urges you on with deep, guttural moans as you kiss along each twitching mound of muscle.  You suckle and lick over his nipple, causing it to stiffen under your attention.  \"<i>F-fuck yeah. Make it shine, filthy bitch,</i>\" Ro'gar growls as you glance over to notice the swelling bulge in his shorts.  You alternate between lapping at one nipple and flicking and pinching the other with your fingers, driving the orc under you wild.  Looking up at his lust-ridden face makes you smirk.  Spying his exposed arms and pits thrills you further, and you crawl over to dip your face into his armpit and begin to lick around.  Ro'gar gives a surprised gasp, and soon his lips curl into a wicked grin. \"<i>Nasty piggy, give my sweaty pit a big ol' tongue bath.</i>\"  Each breath is a moan into his pit, your mouth and tongue tending to Ro'gar's body dutifully, licking off all of the salty sweat and slime you can find.  Ro'gar's hands slide from behind his head and grip onto the back of yours, nestling into your " + hairDescript() + ".\n\n");

	outputText("\"<i>Ya missed a spot.</i>\"  He shoves your head down to rub your [face] over his groin, his tented shorts pressed against your cheek as you moan and lick over the bulge.  Every lick brings another needy groan from Ro'gar, until finally his patience wears thin.  \"<i>Time to get you dirty, pig.</i>\"  He snarls as his free hand yanks down his shorts, kicking them off and exposing himself.  His massive green girth slaps against your [face].  The fat member is thick and easily ten inches long.  He grips the hilt of his gigantic shaft and begins to slap your cheeks with his erection.  \"<i>Piggy's not doing his job.  Gotta clean every last inch of me,</i>\" he teases, smearing his drooling cockhead over your cheeks as your tongue sticks out to catch the dripping length.  You can't help but feel like a hungry whore as you chase Ro'gar's orc cock.");
	//[(if player has tail)
...
public function rogarThirdPhase():void {
	...
	if((player.biggestTitSize() >= 2)) {
		if(flags[kFLAGS.ROGAR_WARNING] == 0) {
			outputText("Judging the patron's figure based on how imposingly filled out the cloak is, he or she is clearly very muscled.  You spy a green hand reach for a can and a spark of recognition hits you.  You're completely unsure how to break the ice, but tug on the hem of the cloak.  The figure turns toward you, and you're greeted with the green, toothy smile of Ro'gar, the orc from the swamp!  \"<i>H'lo, [name]!  I'm s'rprised to see ya here...</i>\"\n\n");
			camp.codex.unlockEntry(kFLAGS.CODEX_ENTRY_ORCS);
	...
	//((androgynous or masculine and breasts <= A-cup))
		...
		if(flags[kFLAGS.ROGAR_DIRT] == 0) {
			outputText("You chat for a while longer before separating.  Ro'gar extracts a promise from you to come drink with him again before waving you off with his standard grin.");
		...
		//(else if Dirt Mc Girt = 2)
			...
			if(player.gender == 2 || player.gender == 0) {
				...
				if(player.cor < 50) outputText("blush");
				else outputText("fantasize about those strong hands touching every part of you");
				outputText(".  I drink here whenever I'm not werkin' out or on a job.  I'll be waitin' for you.</i>\"  He lowers his eyelids suggestively at you, then gets up; you smile dumbly as he leaves the bar, watching him go with a blush in your cheeks");
				//[(If player has a tail)
				if(player.hasLongTail() > 0 && player.isNaga()) outputText(", and you feel your tail flicking rapidly in excitement");
				outputText(".\n\n");
...
public function rogarPhaseFour():void {
	...
	if((player.biggestTitSize() >= 2) && flags[kFLAGS.ROGAR_WARNING] == 0) {
		...
		if(player.biggestTitSize() >= 2) outputText(" and your " + chestDesc());
	...
	//(high fem or breasts >=B-cup and Ro'roh Raggy =1)
		...
		outputText("Ro'gar the orc is here drinking again, but as you catch his eye, a pained expression flashes across his face as he looks over your form.  It's clear he doesn't relish the prospect of talking to you right now, but knowing him, he's too polite to say so.  The wind spills from your sails and your icebreaker slips from your mind - answering him with a simple glance of resignation is the most you can manage.  He gives you a weak smile and returns to his drink.");
		//return to bar menu
		doNext(telAdre.barTelAdre);
	}
	//(andro or masculine with tits <= A)
	else {
		outputText("Ro'gar is tipping his drink back when he catches sight of you, and waves you over.  \"<i>Ah, good ta see ya, [name]!");
		//[(Ro'roh Raggy = 1)
		if(flags[kFLAGS.ROGAR_WARNING] == 1) {
			outputText("Yer lookin' much better today; ya been workin' out?</i>\"  You smile at the compliment, and ");
		}
		else outputText("</i>\"  You ");
		outputText("wave the bartender over for another round.  \"<i>So,</i>\" he begins once you've finished your drinks and she's out of earshot, \"<i>I was wonderin' if ya would like to hang out at my place later?  It ain't much, but it'd be a lot more... private... than here.</i>\"  He colors slightly and waggles an eyebrow at you, then slides a hand into your groin.");
		//[(if F or U)
		if(player.gender == 2 || player.gender == 0) {
			...
			if(flags[kFLAGS.ROGAR_DIRT] == 1) outputText("</i>\"I know ya probably ain't ever imagined hangin' out with a feller like me, but... I could really use the company tonight.</i>\"  ");
			outputText("He's clearly in the mood for some fun; do you want to head back to his place and do something?");
...
private function noTHanksRogarIAintGayDudeIjustLickedThatMudToBeNice():void {
	clearOutput();
	spriteSelect(SpriteDb.s_rogar);
	outputText("You smile at the orc, but tell him that you're not really in the mood to hang out right now.  He looks crestfallen, but nods at you.  \"<i>Well, I understan'.  I'll be seein' ya later, then.</i>\"");
	//Bar menu!
	doNext(telAdre.barTelAdre);
}
...
private function loseButtGinity():void {
	...
	if(player.ass.analLooseness == 0) {
		...
		if(player.cor < 33) outputText("shyly ");
		else if(player.cor > 66) outputText("eagerly ");
		...
		outputText("He yanks your wrists behind your back, ignoring your faint gasps.  With a rustle of cloth, your wrists are bound together behind your back tightly; your fingers feel over the bonds but you struggle against them in vain.  Looking over your shoulder in confusion at Ro'gar, you only see his lust-ridden face dipping down to kiss at your lips.  His tusks press against your cheeks with a demanding snarl and his tongue into your mouth; your [butt] receives a smack, forcing you to yelp.  His tongue quickly invades, and his free hand unfastens your [armor] to strip you forcefully.  Rough, calloused fingers dance over your body and fasten onto your " + nippleDescript(0) + "s, coaxing moans from your throat with each pinch.  Your pleased noises are muffled by Ro'gar's mouth, his tongue and lips hushing each whimper and gasp you breathe.  A bare, firm chest presses against your exposed back, and you pant as the heat from his body burns against you, only intensified by the thin layer of oil on his skin.  Ro'gar's blue eyes watch you like a predator as your face flushes.  He breaks the kiss and cups his hands under your chin to hold your face in place.  \"<i>Such a perdy face yer makin', [name].  Yer lookin' at me like a proper slut, an' it's makin' me hard seein' ya so needy to be bred.</i>\"  He growls in his throat as his mouth nips over your neck, leaving red marks along your skin where his tusks rub against you.  You can feel the oil and sweat smearing over your back, and your senses go wild.  The room is soon filled with your needy whimpers as " + sMultiCockDesc() + " oozes and throbs against the sheets, making the fabric damp with your lust.\n\n");

		outputText("With an abrupt grunt you feel hands gripping your " + hipDescript() + " and pulling your rear into the air, making you balance on your face and knees.  Ro'gar begins to play with your [butt]; each hand massages a cheek between his fingers, squeezing and kneading them apart.  A finger rubs over your sensitive entrance and you shudder softly.  The orc tests its resistance with his finger, pressing in and threatening to penetrate, rubbing harder around the tight, puckered flesh.  Your virgin hole's taut flesh remains resistant to all the coaxing Ro'gar's finger lavishes on it. \"<i>Tarnation, [name].  You're so tight...</i>\"  You feel your cheeks blush with bright color and in a low voice you admit you've never had anyone inside you.\n\n");
	...
	//(([Get Anal] Scenario 1b: Get fucked (normal)))
		...
		//(else)
			...
			outputText("\"<i>Enough horsin' around.</i>\"  Ro'gar snarls as his arms quickly yank back, sneaking under your legs and hoisting you up as he gets to his feet.  You grip Ro'gar's shoulders tight as he lifts you with a strained grunt.  You delight with sharp little moans as he begins to fuck you skyward, bouncing you off of his hips with each slam of his cock into you.  Slowly Ro'gar steps towards a wall, taking his time to be sure not to drop you, and you soon feel the cool surface pressed to your back.  Caught between a cock and a hard place, you stare into Ro'gar's predatory gaze as he holds you hoisted in the air and pinned, making you feel vulnerable.  The orc takes advantage of you and begins to abuse your " + assholeDescript() + ", making your head tilt back to moan out helplessly.");
			outputText("  " +  SMultiCockDesc() + " lays out over your chest, dribbling pre-cum on your skin as you make a mess of your torso in lust.");
			//[(if player has tail)
...
private function fuckRogarsButtPussyBoyCuntManMoundSissySlitQueerQuim():void {
	...
	//((If cock is between 18 and 4 inches))
		...
		//(If horse cock)
		else if(player.cocks[0].cockType == CockTypesEnum.HORSE) outputText("  The flared head of your [cock] nestles in Ro'gar's hole.  His breath quickens as you push in, the girthy, flared head stretching Ro'gar's insides impossibly.  You simply thrust and buck you way deeper within the green pucker to force more of your lengthy shaft past that olive rosebud each time.\n\n");
		//(If dog cock)
		...
		//(If other cock)
		else outputText("  Breaking Ro'gar's orc hole open, you thrust deep within his hot, tight depths.  The burly orc pants with heated breaths, humid air fluttering out of his tusked mouth.  His musclegut heaves, each breath punctuating the thrusts of your hips.  You plow his ass roughly, pulling out until only the head remains inside him before plunging back in further than before.  Ro'gar grunts low in his chest with each bit of progress made, his strong, calloused hand stroking his drooling cock.  \"<i>Mmmf, [name],</i>\" he groans as you finally hilt yourself within him.");
		//end racialdicks, still inside right fit path

		outputText("\n\nYou grip his hips and begin a steady pace, slapping flesh loudly against his muscled ass.  His thick, powerful legs twitch in the air as you pound into his orcish hole, and the orc's toes curl visibly with each brutal thrust you make into him.  You groan as his musk makes your [cocks] throb all the more within him.  To further his humiliation, you whisper in his pointed ear how good he feels wrapped around your length.  He blushes a lime green before you make him groan out your name with a rough smack over his ass.");
		if(player.cockTotal() > 2) outputText("  Your other cocks grind over that firm orc rump, drooling over his skin and making his rear glisten with your sex.");
		else if(player.cockTotal() > 1) outputText("  Your other cock grinds over that firm orc rump, drooling over his skin and making his rear glisten with your sex.");
		outputText("You decide to see how loud you can make him moan and begin ramming deep within him.  The thrusts slam hard enough to make Ro'gar's back arch, your bulbous cockhead prodding his buried prostate with each hilt.  His big hand beats furiously at his massive orc cock, strained groans bellowing out loudly as his heavy sack clenches tight against the base of his green rod.  Orc spunk flies out over his chest, hitting his chin and splattering over his heaving pecs.  His cum collects between his bulging muscles and splashes over his head.  Ro'gar's anal walls clench down tight around you as you pick up the pace of your brutal fuck; your [cock] is milked hard as you feel your climax rapidly approaching.  Sweat drips from your body onto Ro'gar's skin, and you finally feel yourself hit the edge.  With a burst of ecstasy you hilt completely within your orc fuck toy.");
		//[(If dog cock)
...
private function frotWithRogar():void {
	...
	clearOutput();
	spriteSelect(SpriteDb.s_rogar);
	outputText("You allow yourself to be led into Ro'gar's apartment and look around the modestly furnished lounge. Ro'gar seats himself in a cushioned chair.  \"<i>Thanks fer comin'.  I missed ya.</i>\"  He snickers, and you draw closer. His calloused hand reaches down to cup your [butt].  He smirks at you, the frisky orc chuckling deeply and firmly squeezing.  You retaliate with a hard smack against Ro'gar's muscled rump.  He growls low, answering the challenge and crashing his lips into your own.  Muffled grunts and groans issue from both of you as you undress each other.  Soon you are standing in the nude and Ro'gar's hefty cock presses against your [cocks].\n\n");
	//(If multiple cocks)
	if(player.cockTotal() > 1) {
		outputText("Feeling your lengths stiffen against Ro'gar's hard green monster, you buck against Ro'gar's hard need, enveloping it in your cocks and coaxing a lewd groan from the orc.  Ro'gar growls as he feels his orc length surrounded, his green member being slathered with your pre-cum from multiple directions.  His arms wrap around you as he fucks your [cocks], grinding his orc cock between all your lengths; he presses his tusks against your neck and suckles, teeth grating the flesh while his tongue passes over the indentations they leave behind.  Ro'gar backs you up and you feel a hard wall behind you.  His oil-coated body rubs over your own, smearing onto your chest, arms, and hips.  Your hands grip tightly to Ro'gar's back as you grind into him with your [cocks].  Ro'gar reaches his hand down, wrapping his fingers around his length and the nearest cock to it, then strokes them slowly.  Hot breath washes over your face as he stares deep into your eyes, the deep blue pools hazed with lust as you fuck against each other's loins.  Your two bodies mingle with sweat and pre-cum, and soon your groins are sticky and glazed.  You fuck your cocks together, the strong scent of man musk filling your nose and sending a shudder down your spine and a thrill through your groin.  Ro'gar suddenly moans, his orc cock caught between your [cocks] as he unloads over your chest.  His heavy sack clenches tight beneath his cock as he spills his thick seed onto you, coating you in his countless ropes.  The heat warms your skin as you reach your limit; each of your [cocks] twitches, hot and sticky spunk splashing over Ro'gar's olive skin.\n\n");
	}
	//(If single cock)
	else {
...
private function kinkyWithDaOrc():void {
	...
	outputText("over the threshold, and then look around the apartment.  He points out the small kitchen area and then, rather sheepishly, the bedroom.  You're examining it when something catches your eye...\n\n");
	outputText("You bend over the bed to grip a small bottle lying in the soft fabric of the sheets.  Turning it over, you tilt your head as you read the label.  It's... a bottle of lubricant.  Suddenly, there is a loud thud behind you and the bottle drops from your hand as your torso is pressed into the cushioned surface of the bed.  Something presses into your back.  \"<i>Gotcha...</i>\" the familiar voice snickers in your ear.  Ro'gar's head leans over your shoulder and a long, orcish tongue licks your cheek.  \"<i>Was waitin' for this...</i>\" he purrs; the resonance of his voice rumbles against your ear.  Ro'gar chuckles and grips around your wrists.  \"<i>Now that yer here, it's time ta break in this here new bed with sumthin' I've been cravin' since I washed ya down in that swamp, boy.</i>\"  Ro'gar's tone suddenly takes a demanding, hissing tone.  His tongue flicks over your ear as he speaks.  Your skin begins to grow goosebumps as shivers crawl down your spine.\n\n");
	outputText("He yanks your wrists behind your back, ignoring your faint gasps.  With a rustle of cloth, your wrists are bound together behind your back tightly; your fingers feel over the bonds but you struggle against them in vain.  Looking over your shoulder in ");
	if(player.lib < 33) outputText("feigned confusion ");
	else if (player.lib > 66) outputText("clear lust ");
	outputText("at Ro'gar, you only see his lust-ridden face dipping down to kiss at your lips.  His tusks press against your cheeks with a demanding snarl and his tongue into your mouth; your [butt] receives a smack, forcing you to yelp.  His tongue quickly invades, and his free hand unfastens your [armor] to strip you forcefully.  Rough, calloused fingers dance over your body and fasten onto your " + nippleDescript(0) + "s, coaxing moans from your throat with each pinch.  Your pleased noises are muffled by Ro'gar's mouth, his tongue and lips hushing each whimper and gasp you breathe.  A bare, firm chest presses against your exposed back, and you pant as the heat from his body burns against you, only intensified by the thin layer of oil on his skin.  Ro'gar's blue eyes watch you like a predator as your face flushes.  He breaks the kiss and cups his hands under your chin to hold your face in place.  \"<i>Such a perdy face yer makin', [name].  Yer lookin' at me like a proper slut, an' it's makin' me hard seein' ya so needy to be bred.</i>\"  He growls in his throat as his mouth nips over your neck, leaving red marks along your skin where his tusks rub against you.  You can feel the oil and sweat smearing over your back, and your senses go wild.  The room is soon filled with your needy whimpers as " + sMultiCockDesc() + " oozes and throbs against the sheets, making the fabric damp with your lust.\n\n");
	...
	if (player.ass.analLooseness < 3) outputText("\"<i>Tarnation, [name].  You're so tight...</i>\"\n\n");
	...
	outputText("Ro'gar produces harsh snarls, eagerly tonguefucking you, eating you out as his lips work over your ass.  His fingers grip your " + hipDescript() + " roughly as he ravages your hole in a manner beyond your wildest dreams.  You hear slapping as Ro'gar's hips smack involuntarily against the side of the bed.  His aching erection drools globs of thick slime over the sheets, barely restraining his desire to fuck you senseless.  \"<i>Relax!</i>\" Ro'gar barks in a commanding tone that shocks you.  You try to comply with a whimper, feeling something pressed against you.  Ro'gar's fat finger prods your spit-slicked pucker, slipping in with a wet shlick.  You shudder as his digit slides into you");
	...
	outputText(" and rubs over your walls as he pulls your rim open, forcing another finger inside and making you moan like a bitch in heat.  Working the pair of fingers together inside of you, he slowly moves them apart and stretches your hole wide.");

	outputText("  Fingers and [feet] curl in pleasure as your boycunt is forced open by Ro'gar's steady coaxing.");
	...
	else if (player.ass.analLooseness < 5) outputText("your well-used hole. You moan with need as he stretches you wide around his length, continuing without hesitation until he's inside.");
	player.buttChange(25, true, true, false);
...
private function rubdubWithDaOrcWithoutDucky():void {
	...
	outputText("\"<i>I purchased these oils to relax my muscles after spending so much time in the gym.</i>\" Your orc lover motions to a few bottle of oils on his night stand. \"<i>How about you give me a hand... or two.</i>\" Ro'gar grins at you, his eyebrows twitching suggestively. You need no further provocation as you strip from your [armor], you let it fall into a pile on the floor as you make for the bottle. Ro'gar grins and rolls onto his stomach.\n\n");
	...
	outputText("Without any hesitation you straddle the orc's hips again, his engorged orc cock brushing against the bare skin of your " + buttDescript () + ". Your hands get to work smearing the relaxing oil over Ro'gar's body. The orc stares at you with a lurid gaze as you massage his bulging pectorals, teasing his darkened nipples with your fingers. You grin feeling Ro'gar's thick cock pressing more against your " + buttDescript () + " as his chest rumbles under your hands.\n\n");
        outputText("\"<i>You're good at this [name], have you done this before?</i>\" Ro'gar purrs as you work over his abdominals, tracing over every gap with your fingertips, the oils glistening over your lover's body. Ro'gar's hips buck gently, bumping your " + buttDescript () + " with his throbbing cock with a chuckle, his mouth curls into a coy smile. You watch as Ro'gar reaches his arms back, resting his head on his hands as he bares his underarm and pits.\n\n");
