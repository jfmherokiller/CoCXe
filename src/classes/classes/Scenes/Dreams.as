...
public class Dreams {
    ...
    public function dreamSelect():Boolean {
        ...
        if(CoC.instance.flags[kFLAGS.AKBAL_SUBMISSION_COUNTER] > 4) {
            if(CoC.instance.flags[kFLAGS.AKBAL_SUBMISSION_COUNTER] > 10) choices[choices.length] = 7;
            if(CoC.instance.flags[kFLAGS.AKBAL_SUBMISSION_COUNTER] > 13) choices[choices.length] = 7;
            if(CoC.instance.flags[kFLAGS.AKBAL_SUBMISSION_COUNTER] > 15) choices[choices.length] = 7;
            if(CoC.instance.flags[kFLAGS.AKBAL_SUBMISSION_COUNTER] > 18) choices[choices.length] = 7;
        ...
        if(dreamtemp > 5) {
            ...
            //canine
                ...
                //female
                    ...
                    //heat dream!
                    if(player.inHeat) {
                        EngineCore.outputText("being pregnant, your belly bulging obscenely with the fruits of all your frequent copulations, and your breasts swollen with breast milk.  You imagine your condition enhancing your libido, driving you seek out sexual partners willing to pleasure your distorted form.  ");
                    }
                    //normal dream
                    else
                    {
                        EngineCore.outputText("being in heat, your cunt sopping wet with moisture and desire, intense pheromones pouring off you to make all the males rigid and ready.  ");
                    }
                }
            }
            //horse
            ...
            //cow
                ...
                if ((player.gender == 1 && player.biggestTitSize() >= 5) || (player.gender == 3 && Utils.rand(2) == 0)) {
            ...
            //minotaur cum
                ...
                EngineCore.outputText("Akbal's strong hand rests on your shoulder.  You nearly leap in excitement, but allow yourself to be bent forward over the altar.  \"<i>You please me, Buttslut,</i>\" the Lord of Terrestrial Fire whispers in your mind.  It is both title and name, the most important office in the one true religion.  He honors you with his cock, spreading your asshole around him and entering you deep.\n\n");

                EngineCore.outputText("You cum.  You scream in glorious and divine pleasure, granted by your immaculate god.  The acolytes watching masturbate themselves, in awe of the raptured orgasm Akbal has granted you.  Your tongue lolls out as he pounds into you, the haze of delight briefly devouring your thoughts in all-consuming green fire.\n\n");

                EngineCore.outputText("\"<i>Glory unto Akbal,</i>\" Buttslut whispers.\n\n");

                EngineCore.outputText("You awake with a start, grumbling slightly before turning over and trying to get back to sleep.  Your asshole twitches.");
            }
            //Exgartuboobs
            else if(daydream == 8) {
                EngineCore.outputText("drifting through darkness to arrive at your lover's bed.  She purrs and beckons you over, almost entirely hidden behind her massive chest.  You grunt slightly, and between your legs your cock rises, rises, rises - growing in measurements of feet rather than inches.  Excited and eager she moans as you enter her cleavage, thrusting into the ample soft flesh eagerly.\n\n");
            ...
            //Scylla + dom + dong
                ...
                if(player.gender <= 1) {
                    if (Utils.rand(2) == 0) {
                        ...
                        if(player.hasCock()) EngineCore.outputText("  [EachCock] is fully erect and throbbing.");
                        else if(player.hasVagina()) EngineCore.outputText("  Your [vagina] dripping wet with need.");
                        EngineCore.outputText("  You shudder as you recall the erotic dream you were just having, a hand caressing your aching loins.");
                        //end dream
                        //lust increase
                    }
                ...
                if (player.gender == 0 || Utils.rand(2) == 0) {
    ...
    public function dayTenDreams():void {
        ...
        if(CoC.instance.player.hasCock()) {
            if(CoC.instance.player.cor < 50) {
                EngineCore.outputText("Your task completed, you return through the portal to your home.  Exhausted but happy, the sight of your village fills you with a surge of emotions.  Most prominently, and perhaps most enjoyably: pride.  You did it.\n\n");

                EngineCore.outputText("You drink and celebrate with your people long into the night, feasting and receiving accolades and praise.  It is a party the likes of which you have never seen, and rightfully so.  Never again will your village be threatened by the demons.  Late in the evening, you arrive at the home of your childhood and greet your mother.\n\n");

                EngineCore.outputText("\"<i>Welcome back,</i>\" she smiles.\n\n");

                EngineCore.outputText("\"<i>Thank you, Mom,</i>\" you respond, wrapping your arms around her and kissing her deeply.  Your hands take hold of her rear, gripping-\n\n");

                EngineCore.outputText("Shocked awake, you blink as the light of your dying fire flickers dimly across the campsite.  That was...\n\n");

                EngineCore.outputText("This place is getting to you.");
            }
            else {
                EngineCore.outputText("Your task completed, you return through the portal to your home.  Exhausted but happy, the sight of your village fills you with a surge of emotions.  Most prominently, and perhaps most enjoyably: pride.  You did it.\n\n");
                ...
                EngineCore.outputText("\"<i>Thank you, Mom,</i>\" you respond, wrapping your arms around her and kissing her deeply.  Your hands take hold of her rear, gripping it in great handfuls and squeezing her possessively.  Nearly throwing her in the bed, you delight in her playful squeals.  Mounting her, you tear away her dress and plunge into her cunt.\n\n");

                EngineCore.outputText("\"<i>Oooh, god!</i>\" she exclaims,  \"<i>Such a good boy!  Such a big boy!</i>\"\n\n");

                EngineCore.outputText("\"<i>That's right, Mom,</i>\" you grunt, taking hold of her breast and sucking harshly on it.  \"<i>All grown up.</i>\"  You continue to grope her roughly as you pound into her cunt, slapping your balls into her thighs.  Her pussy squeezes you with a mother's love, and you soon find yourself dumping heaping loads of your spunk within her.  You rise, and bring your dick to her mouth so that she can clean you.\n\n");

                EngineCore.outputText("As your mother laps at your shaft, coated in her juices, you look confidently down at her belly.  Though you love your mother, you're looking forward to having a daughter, and training her to love you just as much as a mother does. One day, perhaps even to replace her.\n\n");

                EngineCore.outputText("You awaken in a sweat.  Fuck.");
            }
        }
        else {
            if(CoC.instance.player.cor < 50) {
                ...
                EngineCore.outputText("\"<i>Welcome back,</i>\" he smiles.\n\n");

                EngineCore.outputText("\"<i>Thank you, daddy,</i>\" you respond, wrapping your arms around him and kissing him deeply.  Your hands slip into his pants, lowering-\n\n");
                ...
                EngineCore.outputText("\"<i>Thank you, daddy,</i>\" you respond, wrapping your arms around him and kissing him deeply.  Your hands slip into his pants, lowering them and exposing his crotch.  Too excited to control yourself, you drag your lips down his chest before wrapping them around his cock and taking him into your mouth.  You pull him deep, teasing his balls with your lower lip.  Though it isn't necessary to gag - you could have swallowed him easily - you do anyway.  Daddy deserves a show.\n\n");

                EngineCore.outputText("His cum splatters into your throat.\n\n");

                EngineCore.outputText("You smile with glazed teeth as you straddle him in his bed and mount him.  Some disappointment lingers in you that you didn't just let daddy take your ass then and there, but the prospect of his cum flooding your womb and fertilizing you is too delightful to pass up.\n\n");

                EngineCore.outputText("\"<i>Do you like it?</i>\" you ask, before moaning his name.\n\n");

                EngineCore.outputText("\"<i>You're a good girl,</i>\" he answers.\n\n");

                EngineCore.outputText("His balls gurgle as they fill you.  You squeal in delight and lick his chest, demonstrating your affection.  Clenching him tightly, you make sure not to spill daddy's seed, and imagine giving birth to a sexy, busty daughter, teaching her to love him.  One day, teaching her to replace you.\n\n");
    ...
    public function displacerDreamII():void {
        ...
        if(EngineCore.silly()) EngineCore.outputText("k");
        EngineCore.outputText("not a drop of jism has escaped.");
        ...
        CoC.instance.player.orgasm();
        CoC.instance.player.dynStats("lib", 2, "sen", 2);
        EngineCore.menu();
        EngineCore.addButton(0,"Next",displacerDreamIII);
    }

    public function displacerDreamIII():void {
        EngineCore.clearOutput();
        EngineCore.outputText("The details of the dream immediately begin to slip away.  You strain your brain, trying to commit everything to memory, but it slips out of your mind like water through a sieve.");
        ...
        var x:int = CoC.instance.player.cockTotal();
        while (x > 0) {
            x--;
